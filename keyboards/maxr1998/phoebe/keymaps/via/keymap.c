 ...
 */
[_QWERTZ] = LAYOUT(
  KC_ESC,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,    KC_8,    KC_9,    KC_0,    DE_QUES,
  ...
  KC_LCTL, KC_LGUI, KC_LALT, XXXXXXX, KC_SC,       KC_SPC,       KC_ALGR, KC_FN,   KC_LEFT, KC_DOWN, KC_RGHT
),
...
[_FN] = LAYOUT(
  ...
  _______, _______, _______, _______, _______, G_1,     _______, RGB_M_P, RGB_M_SW,RGB_M_SN,_______, _______,
